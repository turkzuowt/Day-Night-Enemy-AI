...
public class AIFollow : MonoBehaviour {
	...
	public void Start () {
		...
		if(targetObject = GameObject.Find("Character"))
	...
	public virtual void ReachedEndOfPath () {
		...
		/////////////////////////////////////////CODE I ADDED IN TO SET REQUIRED ANIMATION//////////////////////////////////////////////////////
	...
	public void Update () {
		...
		/////////////////////////////////////////CODE I ADDED IN///////////////////////////////////////////////////////////////////////////////////
		// Calculate the distance between yourself and the transform position of the skeleton
		float dist = Vector3.Distance(target.position, transform.position);
		
		// The following only happens when you step within his detectingn radius of 25
		if(dist <= 100)
		{
			///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
